...
const CONFIG = {
  ...
  regionalAnchor: {
    ...
    Scotland: { national:{LAB:0.206,CON:0.194,RFM:0.266,LDM:0.122,GRN:0.125},
                regional:{LAB:0.1682,CON:0.1133,RFM:0.1786,LDM:0.0915,GRN:0.0834} },
    Wales:    { national:{LAB:0.206,CON:0.194,RFM:0.266,LDM:0.122,GRN:0.125},
                regional:{LAB:0.1508,CON:0.139,RFM:0.2556,LDM:0.0505,GRN:0.0952} },
    London:   { national:{LAB:0.206,CON:0.194,RFM:0.266,LDM:0.122,GRN:0.125},
                regional:{LAB:0.2949,CON:0.1973,RFM:0.1723,LDM:0.1219,GRN:0.1722} },
  },
  ...
  natBaseline: { SNP: 0.3253, PLC: 0.2585 },
...
function expandInputs(c, cfg){
  const gb = c.gb, rs = cfg.resRegionalScale;
  const sc = regionalSwing(gb,'Scotland',cfg); sc.SNP=c.snpScotland||0; sc.RES=(gb.RES||0)*rs.Scotland;
  const wa = regionalSwing(gb,'Wales',cfg);    wa.PLC=c.plcWales||0;    wa.RES=(gb.RES||0)*rs.Wales;
  ...
  const lo = regionalSwing(gb,'London',cfg);                            lo.RES=(gb.RES||0)*rs.London;
