...
const CONFIG = {
  ...
  regionalAnchor: {
    ...
    Scotland: { national:{LAB:0.244,CON:0.199,RFM:0.242,LDM:0.111,GRN:0.115,RES:0.027},
                regional:{LAB:0.1883,CON:0.1212,RFM:0.1628,LDM:0.0919,GRN:0.0782,RES:0.0192} },
    Wales:    { national:{LAB:0.244,CON:0.199,RFM:0.242,LDM:0.111,GRN:0.115,RES:0.027},
                regional:{LAB:0.1724,CON:0.1379,RFM:0.2253,LDM:0.0427,GRN:0.0915,RES:0.02} },
    London:   { national:{LAB:0.244,CON:0.199,RFM:0.242,LDM:0.111,GRN:0.115,RES:0.027},
                regional:{LAB:0.3136,CON:0.2027,RFM:0.1686,LDM:0.1148,GRN:0.1688,RES:0.0165} },
  },
  ...
  natBaseline: { SNP: 0.3236, PLC: 0.2812 },
