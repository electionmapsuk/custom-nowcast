...
const F = {
  ...
  RES:{CON_GRN:.43,CON_LAB:.44,CON_LDM:.45,GRN_LAB:.16,GRN_LDM:.06,LAB_LDM:.04,GRN_RFM:.17,LAB_RFM:.09,LDM_RFM:.24,CON_SNP:.1,LAB_SNP:.1,LDM_SNP:.1,CON_PLC:.05,LAB_PLC:.05,LDM_PLC:.05},   // non-RFM from RFM; *_RFM from CON
...
const S = {
  ...
  RES:{CON_GRN:.06,CON_LAB:.03,CON_LDM:.07,GRN_LAB:.07,GRN_LDM:.13,LAB_LDM:.2,GRN_RFM:.32,LAB_RFM:.41,LDM_RFM:.37,CON_SNP:0,LAB_SNP:0,LDM_SNP:0,CON_PLC:0,LAB_PLC:0,LDM_PLC:0},   // non-RFM from RFM; *_RFM from CON
  SNP:{__const:.02}, PLC:{__const:.03},
};
...
const CONFIG = {
  ...
  greenPenalty: { floor: 0.05, conWeight: 0.9, refWeight: 0.15, satWeight: 0.45, rightPivot: 0.42, rightExtra: 2.0, rightFloorDrop: 1.0 },
  ...
  regionalAnchor: {
    ...
    Scotland: { national:{LAB:0.261,CON:0.199,RFM:0.238,LDM:0.106,GRN:0.107,RES:0.036},
                regional:{LAB:0.1906,CON:0.1107,RFM:0.1654,LDM:0.0954,GRN:0.0759,RES:0.0263} },
    Wales:    { national:{LAB:0.261,CON:0.199,RFM:0.238,LDM:0.106,GRN:0.107,RES:0.036},
                regional:{LAB:0.2044,CON:0.1302,RFM:0.2579,LDM:0.0547,GRN:0.0845,RES:0.031} },
    London:   { national:{LAB:0.261,CON:0.199,RFM:0.238,LDM:0.106,GRN:0.107,RES:0.036},
                regional:{LAB:0.3138,CON:0.2091,RFM:0.1642,LDM:0.119,GRN:0.1574,RES:0.0252} },
  },
  ...
  natBaseline: { SNP: 0.315, PLC: 0.2283 },
